...
class Banner extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $uploadBannerMobile = $fieldset->addField('mobile_banner', BannerImage::class, [
            'name' => 'mobile_banner',
        ...
        $bannerButtonText = $fieldset->addField('banner_button_text', 'text', [
            'name' => 'banner_button_text',
            'label' => __('button text'),
            'title' => __('banner button text')
        ]);
        ...
        $dependencies = $this->getLayout()->createBlock(Dependence::class)
            ...
            ->addFieldMap($bannerButtonText->getHtmlId(), $bannerButtonText->getName())
            ...
            ->addFieldDependence($bannerButtonText->getName(), $typeBanner->getName(), '0')
