...
namespace Craftroots\Story\Helper;
...
class Data extends AbstractHelper
{
	...
	public function getImageUploader(){
		...
		$mediaDirectory = $this->fileSystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath('Craftroots/Story');
		$result = $uploaderFactory->save($mediaDirectory);
		$imgpath = 'Craftroots/Story/'.$result['file'];
		return $imgpath;
	}
