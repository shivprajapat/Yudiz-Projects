...
import { Col, Offcanvas, Row, FormCheck, Spinner } from 'react-bootstrap'
...
export default function PermissionList({ show, handleClose, rules, roleData, roleDetail, permissionData, savedPermission, isLoading }) {
                ...
                <Controller
                  ...
                  render={({ field: { ref } }) => (
                    <FormCheck style={{
                      ...
                      />
                      <FormCheck.Label htmlFor={`${index}permissionName`}>{item.sName}</FormCheck.Label>
                    </FormCheck>
                  )}
                />
              </Col>
