...
import { FRONT_USER_FILTER } from 'helper/helper'

function CustomerFilters({ filterChange, type, defaultValue, closeDrawer }) {
  ...
  return (
    <Form className='user-filter' onSubmit={handleSubmit(onSubmit)} autoComplete='off'>
      <div className='top-d-button'>
        ...
        <Button variant='primary' type='submit' className='square' size='sm'>
