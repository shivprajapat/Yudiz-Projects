        ...
        <Col sm='4'>
          <Form.Group className='form-group'>
            ...
            <Form.Control
              ...
              register={register}
              errors={errors}
              className={`form-control ${errors.eStatus && 'error'}`}
              value={profileData.sUserName}
              onChange={(e) => handleChange(e)}
            />
            {errors.sNumber && <Form.Control.Feedback type='invalid'>{errors.sUserName.message}</Form.Control.Feedback>}
          </Form.Group>
        </Col>
          ...
          <Form.Group className='form-group'>
            ...
            <Form.Control
              ...
              {...register('sMobile', {
                ...
                maxLength: { value: 13, message: validationErrors.number },
                minLength: { value: 13, message: validationErrors.number }
              })}
          ...
          <Form.Group className='form-group radio-group'>
            ...
            <div className='d-flex mt-2'>
              <Form.Check
                ...
                name='eGender'
                id='Male'
                checked={profileData.eGender === 'male'}
                onChange={(e) => handleChange(e)}
              />
              <Form.Check
                {...register('eGender', { required: validationErrors.required })}
                ...
                name='eGender'
                id='Female'
                checked={profileData.eGender === 'female'}
                onChange={(e) => handleChange(e)}
              />
              <Form.Check
                {...register('eGender', { required: validationErrors.required })}
                ...
                name='eGender'
                id='Other'
                checked={profileData.eGender === 'other'}
                onChange={(e) => handleChange(e)}
              />
            </div>
