...
function AddCategory({ register, errors, control, nameChanged, data, watch, values, setValue, getParentUrl }) {
  ...
  const consideredAsLeagueLabel = useIntl().formatMessage({ id: 'consideredAsLeague' })
              ...
              <OverlayTrigger
                overlay={
                  <Tooltip id='tooltip-disabled'>
                    <FormattedMessage id='pleaseAddSeoRedirectToThisSeries' />
                  </Tooltip>
                }
              >
              ...
              render={({ field: { onChange, value = [], ref } }) => (
                <Select
                  ...
                  getOptionLabel={(option) =>
                    option.sTitle &&
                    `${option.sTitle} - ${option?.sSeason} (${moment(option.dStartDate).format('Do MMM')}) - (${moment(
                      option.dEndDate
                    ).format('Do MMM')})`
                  }
        ...
        <Form.Group className='form-group'>
          ...
          <Controller
            ...
            render={({ field: { onChange, value = [], ref } }) => (
              <Select
                ref={ref}
                value={value || values?.oParentCategory}
