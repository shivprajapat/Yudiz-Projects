...
export const API_URL = process.env.REACT_APP_API_URL || 'https://gateway-dev.crictracker.ml/graphql'
...
export const GLOBAL_WIDGET_BASE_URL = process.env.GLOBAL_WIDGET_BASE_URL || 'https://globalwidget.crictracker.com/api'
export const ARTICLE_BASE_URL = process.env.ARTICLE_BASE_URL || 'https://article-dev.beta.crictracker.com/'
export const FETCH_PLAYLIST_URL =
  process.env.NODE_ENV === 'development' ? 'https://article-dev.crictracker.ml/api/update-playlist' : `${process.env.ARTICLE_BASE_URL}api/update-playlist`
