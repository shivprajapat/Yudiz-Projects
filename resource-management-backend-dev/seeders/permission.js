const Permissions = [
  ...
  {
    sName: 'View Dashboard Monthly Chart',
    sKey: 'VIEW_DASHBOARD_MONTHLY_CHART',
    sModule: 'DASHBOARD',
    eStatus: 'Y',
    bIsActive: true
  },
...
class PermissionSeeder {
  ...
  async seedDb() {
    try {
      ...
      console.log(error)
      console.log('Permissions seeding failed')
    } finally {
      console.log('Permissions seeding operation done')
      // process.exit()
    }
  }
}
