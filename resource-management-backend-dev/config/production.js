const prod = {
  ...
  EMPLOYEE_DB_URL: 'mongodb+srv://pranav:pranav123@cluster0.fpjwy.mongodb.net/resource_managementa?retryWrites=true&w=majority',
  EMPLOYEE_DB_URL_BACK_UP: 'mongodb+srv://pranav:pranav123@cluster0.fpjwy.mongodb.net/resource_management_backup?retryWrites=true&w=majority',
...
-----END PRIVATE KEY-----`,
  ...
  frontUrl: 'http://rmp.webdevprojects.cloud',
  fireBasePushNotification: {
    databaseURL: 'https://resource-management-1c3f5-default-rtdb.firebaseio.com'
  },
  resetLink: 'rmp.webdevprojects.cloud/reset-password?token=add_token&type=reset-link',
  setLink: 'rmp.webdevprojects.cloud/set-password?token=add_token&type=set-link',
  auth: {
    type: 'OAuth2',
  ...
  urlPrefix: 'http://rmp.webdevprojects.cloud'
}
