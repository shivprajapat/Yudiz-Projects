...
const { validate, setLanguage, isAuthenticated, isAuthorized, isOtherPermission, checkExtraPermissison } = require('../../middlewares/middleware')
...
router.use(setLanguage, isAuthenticated, isOtherPermission)
  ...
  .get('/project/:id/v1', isAuthorized('VIEW_PROJECT'), validateInput.getProjectCheck, validate, checkExtraPermissison, projectService.getProject)
  .get('/projects/v1', isAuthorized('VIEW_PROJECT'), checkExtraPermissison, projectService.getProjects)
  .delete('/project/:id/v1', isAuthorized('DELETE_PROJECT'), validateInput.deleteProjectCheck, validate, projectService.deleteProject)
  .get('/project/:id/employees/v1', isAuthorized('VIEW_PROJECT'), validateInput.getProjectsByEmployee, validate, projectService.getProjectByEmployeev1)
  ...
  .get('/employeeProjects', isAuthorized('VIEW_PROJECT'), checkExtraPermissison, projectService.getEmployeeProjects)
  ...
  .get('/projects/closed/v1', isAuthorized('VIEW_CLOSED_PROJECT'), checkExtraPermissison, projectService.getClosedProjects)
