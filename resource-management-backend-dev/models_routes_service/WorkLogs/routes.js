...
router.use(setLanguage, isAuthenticated)
  ...
  .get('/worklogs/v2', setLanguage, isAuthenticated, isAuthorized('VIEW_WORKLOGS'), checkExtraPermissison, workLogsServices.getWorkLogsV2)
  ...
  .get('/worklogstags/v1', setLanguage, workLogsServices.getWorkLogsTags)
