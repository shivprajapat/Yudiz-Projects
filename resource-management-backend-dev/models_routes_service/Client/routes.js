...
const { validate, setLanguage, isAuthenticated, isAuthorized, checkExtraPermissison } = require('../../middlewares/middleware')
const validators = require('./validators')

router.use(setLanguage, isAuthenticated)
  .get('/clients/v1', isAuthorized('VIEW_CLIENT'), checkExtraPermissison, clientService.getClients)
