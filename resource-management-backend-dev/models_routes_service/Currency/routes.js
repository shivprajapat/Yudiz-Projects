...
router
  ...
  .get('/globcurrency/:id/v1', currencyCheckIdV1, validate, currencyService.getCurrency)
  .delete('/globcurrency/:id/v1', isAuthorized('DELETE_CURRENCY'), currencyCheckIdV1, validate, currencyService.deleteCurrency)
  .get('/globcurrency/v1', validate, currencyService.search)
  .get('/globcurrency/currency/v1', validate, currencyService.getCurrencies)
