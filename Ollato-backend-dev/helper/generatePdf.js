...
const pdfGene = async (data = {}) => {
  try {
    ...
    const template = fs.readFileSync(config.INVOICE_TEMPLATE_PATH + 'invoice.ejs', {
    ...
    const filePath = path.resolve(__dirname, `../public/uploads/invoices/package-invoice-${randomStr}.pdf`)
