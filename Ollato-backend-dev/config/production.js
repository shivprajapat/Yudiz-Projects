const prod = {
  DEFAULT_EMAIL: 'seracedu@gmail.com',
  DEPLOY_HOST_URL: process.env.DEPLOY_HOST_URL || 'http://localhost:1340',
  ...
  RECEIVER_EMAIL: process.env.RECEIVER_EMAIL || 'seracedu@gmail.com',
  DB_SQL_NAME: 'ollato',
  DB_SQL_USER: 'root',
  DB_SQL_PASSWORD: 'I3jda2mPAPEwf7OdnAlb',
  DB_SQL_HOST: 'ollato-db.cmwl43mutsas.ap-south-1.rds.amazonaws.com',
  DB_SQL_PORT: 3306,
  DB_SQL_DIALECT: 'mysql',
  HOST_URL: 'ollato-db.cmwl43mutsas.ap-south-1.rds.amazonaws.com',
  ...
  AWS_ACCESS_KEY: 'AKIAR7DFR6V2YD46S67S' || 'your aws access key',
  AWS_SECRET_KEY: 'ecAG4P6MEGRCm7pyDcHmDpnQ0hvU10Ayj4EQigsG' || 'your aws secretAccessKey',
...
-----END PUBLIC KEY-----`,
  ...
  REZORPAY_KEY_ID: process.env.PRO_REZORPAY_KEY_ID,
  REZORPAY_KEY_SECRET: process.env.PRO_REZORPAY_KEY_SECRET,
