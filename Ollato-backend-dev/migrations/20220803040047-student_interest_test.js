...
module.exports = {
  async up (queryInterface, Sequelize) {
     ...
     */
    await queryInterface.createTable('student_interest_tests', {
      ...
      student_calc_test_id: {
        type: Sequelize.INTEGER,
        references: {
          model: 'student_calc_tests', // 'student_calc_tests' refers to table name
          key: 'id' // 'id' refers to column name in student_calc_tests table
        }
      },
      package_id: {
        type: Sequelize.INTEGER,
        references: {
          ...
          key: 'id' // 'id' refers to column name in packages table
        }
      },
      student_package_id: {
        type: Sequelize.INTEGER,
  ...
  async down (queryInterface, Sequelize) {
     ...
     */
    await queryInterface.dropTable('student_interest_tests')
  }
}
