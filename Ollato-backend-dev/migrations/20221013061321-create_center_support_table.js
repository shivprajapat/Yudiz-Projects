...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.createTable('center_support', {
      ...
      issue_category_id: {
        type: Sequelize.INTEGER,
        references: {
          model: 'counsellor_issue_category', // 'center_issue_category' refers to table name
          key: 'id' // 'id' refers to column name in center_issue_category table
        }
      },
  ...
  async down (queryInterface, Sequelize) {
    await queryInterface.dropTable('center_support')
  }
}
