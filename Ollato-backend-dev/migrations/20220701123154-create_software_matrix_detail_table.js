...
module.exports = {
  async up (queryInterface, Sequelize) {
     ...
     */
    await queryInterface.createTable('software_matrix_details', {
      ...
      norm_values: { type: Sequelize.STRING(), allowNull: false },
  ...
  async down (queryInterface, Sequelize) {
     ...
     */
    await queryInterface.dropTable('software_matrix_details')
  }
}
