...
describe('test management routes', () => {
  before(async () => {
    ...
    routes = {
      getAllTests: '/api/v1/admin/test/test-category/get-all',
      getByIdTest: '/api/v1/admin/test/test-category/get-by-id',
      createTest: '/api/v1/admin/test/test-category/create',
      updateTest: '/api/v1/admin/test/test-category/update',
      deleteTest: '/api/v1/admin/test/test-category/delete'
    }
  })
    ...
    describe('/POST get test by id ', () => {
      ...
      it('should not get test by id', (done) => {
        ...
        request(server)
          ...
          .end(function(err, res) {
            if (err) return done(err)
            expect(res.body.message).toMatch('Test category does not exist.')
            done()
          })
      })
    })
    ...
    it('should create a test ', (done) => {
      ...
      request(server)
        ...
        .end(function (err, res) {
          if (err) return done(err)
          expect(res.body.data).toBeA('object')
          expect(res.body.message).toMatch(messages.en.add_success.replace('##', messages.en.testCategory))
    ...
    it('should not create a test ', (done) => {
      ...
      request(server)
        ...
        .end(function (err, res) {
          ...
          expect(res.body.message).toMatch(messages.en.already_exist.replace('##', messages.en.testCategory))
          done()
        })
    })
    ...
    it('should update a test ', (done) => {
      ...
      request(server)
        ...
        .end(function (err, res) {
          if (err) return done(err)
          expect(res.body).toBeA('object')
          expect(res.body.message).toMatch(messages.en.update_success.replace('##', messages.en.testCategory))
          done()
        })
    })
    ...
    it('should delete a test ', (done) => {
      ...
      request(server)
        ...
        .end(function (err, res) {
          if (err) return done(err)
          expect(res.body).toBeA('object')
          expect(res.body.message).toMatch(messages.en.del_success.replace('##', messages.en.testCategory))
          done()
        })
    })
    ...
    it('should not delete a test', (done) => {
      ...
      request(server)
        ...
        .end(function (err, res) {
          if (err) return done(err)
          expect(res.body).toBeA('object')
          expect(res.body.message).toMatch(messages.en.not_exist.replace('##', messages.en.testCategory))
          done()
        })
    })
  })
