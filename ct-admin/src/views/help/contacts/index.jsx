...
function Contacts({ userPermission }) {
  ...
  const [tabs, setTabs] = useState([
    { name: <FormattedMessage id="generalIssue" />, internalName: 'generalIssue', active: true },
    { name: <FormattedMessage id="technicalIssue" />, internalName: 'technicalIssue', active: false }
  ])
