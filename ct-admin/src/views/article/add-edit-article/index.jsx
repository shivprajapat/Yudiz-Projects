...
function AddEditArticle({ userPermission }) {
  ...
  function getEditPermission(data) {
    ...
    if (data.eState === 'pub' && userPermission.includes('PUBLISH_SAVE_CHANGES')) return false
    return true
  }
          ...
          <Col md="4">
            <div className="sticky-column">
              ...
              <FeaturedImage
                ...
                clearErrors={clearErrors}
              />
              <TagYourContent control={control} values={getValues()} disabled={isDisable} addCategoryURL={setCategoryUrl} errors={errors} />
              {id && (
