...
function TagMigrationTeamItemRow({
  tag,
  index,
  selectedTag,
  onSelect,
  ...
  const defaultValue = { label: <FormattedMessage id="team" />, value: 'team' }
...
TagMigrationTeamItemRow.propTypes = {
...
export default TagMigrationTeamItemRow
