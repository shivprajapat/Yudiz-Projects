                      ...
                      <tr key={p?.oPlayer?._id}>
                        <td>
                          <div className="img-name d-flex align-items-center">
                            ...
                            <span>{p?.oPlayer?.sFirstName}</span>
                          </div>
                        </td>
                        <td>{p?.oTeam?.sAbbr || '-'}</td>
                        <td>
                          ...
                          <td>
                            <div className="d-flex align-items-center player-credit">
                              ...
                              <input
                                ...
                                disabled={
                                  disabled || (!aSelectedPlayer.includes(p?._id) && aSelectedPlayer.length >= 11) || !p.nRating || false
                                }
                              ...
                              {aSelectedPlayer && (
                                <label
                                  ...
                                  className={`${aSelectedPlayer.includes(p?._id) ? 'icon-remove' : 'icon-add-circle1'}`}
                                ></label>
                              )}
                            </div>
                          </td>
                    ...
                    return (
                      <tr key={p?.oPlayer?._id}>
                        ...
                        <td>
                          ...
                          />
                          <label className="s-p" htmlFor={`${pIndex}${p?.oPlayer?._id}${cIndex}iCapFanId`}>
                            <FormattedMessage id="c" />
                          </label>
                        </td>
                        <td>
                          ...
                          />
                          <label className="s-p" htmlFor={`${pIndex}${p?.oPlayer?._id}${cIndex}iVCFanId`}>
                            <FormattedMessage id="vc" />
                          </label>
                        </td>
                      </tr>
