  ...
  return (
    <>
      <div className="probabel-xi">
        <div className="probabel-xi-head d-flex align-items-center justify-content-between">
          <h2>
        ...
        <Row>
            ...
            <Row>
              {players &&
                ...
                players.map((player, index) => {
                  const playerIdNameRole = player._id + ',' + player.sFirstName + ',' + player.sPlayingRole
                  return (
          ...
          <Col lg="4" className="border-block">
            ...
            <div>
              {oTeam1 &&
                oTeam1?.map((player, index) => {
                  return (
                    <Fragment key={index}>
                      <FantasyPlayer player={player} type="oTeam1" setValue={setValue} values={values} register={register} watch={watch} />
                    </Fragment>
                  )
                })}
          ...
          <Col lg="4" className="border-block">
            ...
            <div>
              {typeof oTeam2 === 'string' && oTeam2 === []}
              {typeof oTeam2 !== 'string' &&
                oTeam2 &&
                oTeam2?.length !== 0 &&
                oTeam2?.map((player, index) => {
                  return (
                    <Fragment key={index}>
                      <FantasyPlayer register={register} watch={watch} player={player} type="oTeam2" setValue={setValue} values={values} />
                    </Fragment>
                  )
                })}
