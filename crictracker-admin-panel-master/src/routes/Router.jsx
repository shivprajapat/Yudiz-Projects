...
const AddEditPoll = React.lazy(() => import('views/widgets/global-poll/add-edit-poll'))
...
const Router = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: allRoutes.addPoll, component: AddEditPoll, exact: true, isAllowedTo: 'CREATE_POLL' },
      { path: allRoutes.editPoll(':id'), component: AddEditPoll, exact: true, isAllowedTo: 'EDIT_POLL' },
      { path: allRoutes.miniScorecardPriority, component: MiniscoreCardPriority, exact: true },
