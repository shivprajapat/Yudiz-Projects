...
import { GET_CATEGORY_LIST_ARTICLE, GET_TAG_LIST_ARTICLE, GET_POLL_LIST } from 'graph-ql/article/query'
...
function TagYourContent({ control, disabled, setValue, watch, values, addCategoryURL, errors, isCategoryDisabled }) {
  ...
  const [getPoll, { loading: pollLoading }] = useLazyQuery(GET_POLL_LIST, {
