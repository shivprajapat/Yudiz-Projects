...
import Poll from 'shared/components/poll'
              ...
              if (content?.eType === 'poll') {
                return (
                  <div key={i} className='d-flex gap-3'>
                    ...
                    <Poll content={content} handleDelete={handleDelete}/>
                  </div>
                )
              } else {
                return (
                    ...
                    <div className='live-article-content d-flex flex-column gap-2 live-events-sidebar-editor-content'>
                      <div className='w-100 d-flex align-items-start justify-content-between'>
                        <div className='d-flex flex-column align-items-start'>
                          ...
                          <h5 className="text-uppercase mb-0">{content?.sTitle}</h5>
                          <p className='text-muted text-uppercase'><FormattedMessage id="by" /> {content?.oAuthor?.sFName}</p>
                        </div>
                      ...
                      { content?.oPoll && <Poll content={content} /> }
                      <div dangerouslySetInnerHTML={{ __html: content?.sContent }} />
                    </div>
                  </div>
                )
              }
