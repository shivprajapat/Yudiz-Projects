          ...
          <Row>
            ...
            <Col md="7">
              <div className="wallet-content">
                <p>
                  <FormattedMessage id="chanceToUnlockMostExclusiveBundles" />
                </p>
                <p>
                  <FormattedMessage id="ourRewardsHoldPossibilities" />
                </p>
                <p>
                  <FormattedMessage id="supportArtistsAndGoodCausesToAccessRewards" />
                </p>
