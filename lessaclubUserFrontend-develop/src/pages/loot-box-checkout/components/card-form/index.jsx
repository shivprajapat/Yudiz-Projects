...
const CardForm = ({ hidden, cardFormMethods, onCardSubmit, loading, paymentCardList, onCardSelect, selectedCard, assetDetails }) => {
  ...
  return (
    <Form hidden={hidden} autoComplete="off" id="card-form-loot" className="payment-mode-form">
      <div>
      ...
      <Button type="submit" className="white-btn payment-btn" onClick={handleSubmit(onCardSubmit)} form="card-form-loot" disabled={loading}>
        Buy NFT
