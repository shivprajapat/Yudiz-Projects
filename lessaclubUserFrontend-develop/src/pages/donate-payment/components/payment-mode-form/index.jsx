...
const PaymentModeForm = (props) => {
  ...
  const { hidden, paymentModeFormMethods, onFirstStepSubmit, donationPurchaseData, assetDetails, walletAccountStore, networkCurrencies, nuuCoinsMultiplier, userData } = props
        ...
        {paymentMode === 'Crypto Currency' && (
          <>
            <div className="bid-txt d-flex justify-content-between">
              ...
              <span className="txt-right">{donationPurchaseData?.amount}</span>
            </div>
            ...
            <div className="bid-txt d-flex justify-content-between">
              ...
              <span className="txt-right">
                {`£ 
                  ${getStringWithCommas(donationPurchaseData?.amount)}
                `}
              </span>
            </div>
            <div className="bid-txt d-flex justify-content-between">
