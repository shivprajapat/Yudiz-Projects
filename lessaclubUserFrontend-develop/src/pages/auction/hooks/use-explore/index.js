...
const useExplore = () => {
  ...
  const [exploreAuctions, setExploreAuctions] = useState()
  const [selectedCategory, setSelectedCategory] = useState(null)
  const [category, setCategory] = useState()

  const exploreAuctionData = useSelector((state) => state.explore.explore)
  ...
  useEffect(() => {
    exploreAuctionData && setExploreAuctions(exploreAuctionData)
  }, [exploreAuctionData])
