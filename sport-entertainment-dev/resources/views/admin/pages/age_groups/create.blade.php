...
@push('breadcrumb')
    {!! Breadcrumbs::render('age-groups_create') !!}
@endpush
...
@section('content')
    <div class="container">
        <div class="card card-custom">
            ...
            <!--begin::Form-->
            <form id="addAgeGroup" method="POST" action="{{ route('admin.age-groups.store') }}">
                @csrf
                <div class="card-body">
                    {{-- Name --}}
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('age_name') is-invalid @enderror" id="age_name"
                            name="age_name" value="{{ old('age_name') }}" placeholder="Enter age group name"
                            autocomplete="age_name" spellcheck="false" autocapitalize="sentences" tabindex="0"
                            autofocus />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('minimum_age') is-invalid @enderror" id="minimum_age"
                            name="minimum_age" value="{{ old('minimum_age') }}" placeholder="Enter minimum age" autocomplete="minimum_age"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('maximum_age') is-invalid @enderror" id="maximum_age"
                            name="maximum_age" value="{{ old('maximum_age') }}" placeholder="Enter maximum age" autocomplete="maximum_age"
                            spellcheck="false" autocapitalize="sentences" tabindex="0" autofocus />
