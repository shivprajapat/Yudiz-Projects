...
@push('breadcrumb')
    {!! Breadcrumbs::render('banner-images_list') !!}
@endpush
...
@section('content')
    <div class="container">
        ...
        <div class="card card-custom">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    @if (in_array('delete', $permissions))
                        <a href="{{ route('admin.banner-images.destroy', 0) }}" name="del_select" id="del_select"
                            class="btn btn-sm btn-light-danger font-weight-bolder text-uppercase mr-2 delete_all_link">
                            <i class="far fa-trash-alt"></i> Delete Selected
                        </a>
                    @endif
                    @if (in_array('add', $permissions))
                        <a href="{{ route('admin.banner-images.create') }}"
            ...
            <div class="card-body">
                {{--  Datatable Start  --}}
                <table class="table table-bordered table-hover table-checkable" id="banner_images_table"
...
@push('extra-js')
    ...
    <script>
        ...
        oTable = table.dataTable({
            ...
            "pageLength": 10,
            "ajax": {
                "url": "{{ route('admin.banner-images.listing') }}", // ajax source
            },
