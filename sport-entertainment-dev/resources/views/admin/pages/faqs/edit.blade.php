...
@section('content')
    <div class="container">
        <div class="card card-custom">
            ...
            <!--begin::Form-->
            <form id="frmEditFaq" method="POST" action="{{ route('admin.faqs.update', $faq->id) }}"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        @endphp
                        <option value="{{ FaqTypeEnums::END_USER }}"
                            {{ $faq->faq_type == FaqTypeEnums::END_USER->value ? 'selected' : '' }}>User</option>
                        <option value="{{ FaqTypeEnums::COACHING_CENTRE }}"
                            {{ $faq->faq_type == FaqTypeEnums::COACHING_CENTRE->value ? 'selected' : '' }}>Coaching Centre
                        </option>
                        </select>
