    ...
    <div class="container">
        ...
        <div class="card card-custom">
            ...
            <div class="card-body">
                <div class="row mb-10 ">
                    <div class="col-lg-4">
                        <select class="form-control selectpicker" id="dropdownMenuButton" title="Completion Status">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var oTable = table.dataTable({
                ...
                "ajax": {
                    "data": {
                        completion_status: function() {
                            return selectedText;
                        },
                    },
                    "url": "{{ route('admin.batches.listing') }}", // ajax source
                },
