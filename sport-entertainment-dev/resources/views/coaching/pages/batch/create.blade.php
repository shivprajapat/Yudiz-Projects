...
@section('content')
    <div class="container">
        <div class="card card-custom">
            ...
            <!--begin::Form-->
            <form id="frmBatchCreate" method="POST" action="{{ route('coaching.batch.store') }}"
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name') }}" placeholder="Batch Name" autocomplete="name"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('start_date') is-invalid @enderror"
                                    id="start_date" name="start_date" value="{{ old('start_date') }}" autocomplete="off"
                                    placeholder="Start Date" tabindex="0" />
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('end_date') is-invalid @enderror"
                                    autocomplete="off" id="end_date" name="end_date" value="{{ old('end_date') }}"
                                    placeholder="End Date" tabindex="0" />
                                <div class="input-group-append">
                                    <span class="input-group-text">
                                        <i class="la la-calendar"></i>
                                    </span>
                            ...
                            <select name="age_id" class="select2_age_group form-control">
                                ...
                                @foreach ($age_groups as $age_group)
                                    <option value=" {{ $age_group->id }} "
                                        {{ old('age_id') == $age_group->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group row">
                        <div class="col-md-4 session_days_class">
                        ...
                        <div class="col-md-2">
                            <label for="start_time">Session End:</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('number_of_session') is-invalid @enderror"
                                id="number_of_session" name="number_of_session" value="{{ old('number_of_session') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('actual_price') is-invalid @enderror"
                                id="actual_price" name="actual_price" placeholder="Actual Price" tabindex="0"
                                readonly />
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea type="textarea" class="form-control @error('brief_details') is-invalid @enderror" id="brief_details"
                                name="brief_details" tabindex="0" placeholder="Session Brief"> {{ old('brief_details') }}  </textarea>
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            ...
                            <span class="switch switch-outline switch-icon switch-success">
                                <label>
                                    <input type="checkbox" name="live_status" disabled />
                                    <span></span>
                                </label>
                            </span>
                            <span class="text-muted"> {{ __("SWITCH_MSG") }} </span>
...
@push('extra-js')
    <script>
        ...
        $(document).on('blur', '#price', function() {
            let percentage = "{{ $commission }}";
            let priceVal = $(this).val();
            if (!isNaN(priceVal)) {
                let result = (percentage / 100) * priceVal;
                let actual_price = parseInt(priceVal) - parseInt(result);
