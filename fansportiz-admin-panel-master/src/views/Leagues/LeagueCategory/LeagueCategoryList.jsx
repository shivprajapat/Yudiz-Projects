...
import {
  Button, Col, Modal, ModalBody, Row, UncontrolledAlert
} from 'reactstrap'
...
function LeagueCategoryList (props) {
  ...
  useEffect(() => {
    ...
    data === {}
      ? data = {
        LeagueCategory: props.location.search
      }
      : data.LeagueCategory = props.location.search
                ...
                <Fragment>
                  {
                    list && list.length !== 0 && list.map((data, i) => (
                      <tr key={data._id}>
                        ...
                        <td>{data.sImage ? <img src={url + data.sImage} alt="League Category Image" height={50} width={70} /> : ' No Image '}</td>
                        <td>
                            ...
                            {((Auth && Auth === 'SUPER') || (adminPermission?.LEAGUE !== 'R')) &&
                              ...
                              <li>
                                <Button
                                  ...
                                  disabled={data.sKey === 'hiddenLeague'}
                                >
