      ...
      <Row className="mt-3">
        <Col lg={12} md={12} xs={12}>
          <Controller
            ...
            control={control}
            rules={{ required: 'Please select a Subscription' }}
          ...
          <Controller
            ...
            rules={{
              ...
              validate: (value) => {
                ...
                if (subscriptionList?.find(item => item?._id === params?.id)?.nPrice < getValues('nPrice')) {
                  return 'Transaction amount must not be greater than Subscription'
                }
                return true
              },
            }}
      ...
      <Row className="mt-1">
        <Col lg={6} md={6} xs={12}>
          <Controller
            name="ePaymentTag"
            control={control}
            rules={{ required: 'Payment tag field is required' }}
            render={({ field: { onChange, value, ref }, fieldState: { error } }) => (
              <Select
