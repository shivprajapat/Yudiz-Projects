...
function AddInquiry () {
  ...
  const { mutate: mutateAddVisit } = useMutation((data) => addInquiryVisit(data), {
    onSuccess: (res) => {
      ...
      navigate(route.inquiryAddViewEdit(isEdit ? ('edit', id) : isViewOnly ? ('view', id) : ''))
    },
  })
  ...
  return (
    <>
          ...
          <Col lg={6} md={6} sm={6} xs={12}>
            <Controller
              ...
              rules={{
                ...
                minLength: {
                  value: 10,
                  message: 'Secondary Number must have atleast 10 digits'
                }
              }}
              render={({ field, fieldState: { error } }) => (
                <Input
            ...
            <Row className="mt-xs-3">
              <Col lg={6} md={6} sm={6} xs={12}>
                <Controller
                  name="sPurpose"
                  control={control}
                  rules={{ required: 'Purpose field is required' }}
                  render={({ field, fieldState: { error } }) => (
                    <Input
                      {...field}
                      labelText="Purpose"
              ...
              <Col lg={6} md={6} sm={6} xs={12} className="mt-md-0">
                <Controller
                  name="sPreferredLocation"
                  control={control}
                  rules={{ required: 'Preffered Location is required' }}
                  render={({ field, fieldState: { error } }) => (
                    <Input
                      {...field}
                      labelText="Preferred Location"
            ...
            <Row>
              <Col lg={6} md={6} xs={12} className="mt-md-0">
                <Controller
                  name="iBranchId"
                  control={control}
                  rules={{ required: 'Please select the Branch' }}
        ...
        <>
          ...
          <Wrapper>
            ...
            <DataTable
              ...
              align="left"
              totalData={visit?.aInquiryVisitList?.length}
      ...
      {(isViewOnly || isEdit) && modalVisit && (action !== 'delete') &&
        <CustomModal
      ...
      {(isViewOnly || isEdit) && modalFollowUp && (action !== 'delete') &&
        <CustomModal
          modalBodyClassName="p-0 py-2"
