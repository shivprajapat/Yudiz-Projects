  ...
  if (selectionSet) {
    selectionSet?.selections?.forEach(selection => {
      if (selection?.selectionSet) {
        if (selection.kind === 'InlineFragment') Object.assign(subSelection, _.extractSelection(selection?.selectionSet))
        else subSelection[selection?.name?.value] = _.extractSelection(selection?.selectionSet)
      } else {
