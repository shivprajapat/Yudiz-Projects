...
const UpdateCast = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .put(`${process.env.REACT_APP_AUTH_URL}/cast/${id}`, formData, {
        headers: {
          Authorization: `${token}`
        }
      })
  ...
  const fetchCastDetails = async () => {
    await axios
      .get(`${process.env.REACT_APP_AUTH_URL}/cast/${id}`, {
        headers: {
          Authorization: `${token}`
        }
      })
  ...
  return (
    <Fragment>
      <Breadcrumbs breadCrumbTitle="Super" breadCrumbParent="Cast Management" breadCrumbActive="Update Cast" />
      <Card>
        <CardHeader>
          <CardTitle tag="h4">Update Cast</CardTitle>
        </CardHeader>
        <CardBody>
          <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Row className="main-category-row">
              <Col md="6" sm="12">
                <FormGroup>
                  <Label for="mainCategoryNameEn">Cast Type (English)</Label>
                  <Input
              ...
              <Col md="6" sm="12">
                <FormGroup>
                  <Label for="mainCategoryNameGu">Cast Tyoe (Gujarati)</Label>
                  <Input
