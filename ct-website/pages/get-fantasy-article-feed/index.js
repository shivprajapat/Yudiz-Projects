        ...
        {fantasyArticleData?.oOverview !== null && (
          <>
            <section style={{ marginBottom: '16px' }}>
              ...
              <p className="big-text font-bold mb-1">{fantasyArticleData?.oOverview?.oTeam1?.oTeam?.sTitle}</p>
              ...
              <p className="big-text font-bold mb-1">{fantasyArticleData?.oOverview?.oTeam2?.oTeam?.sTitle}</p>
              <p className="big-text mb-2">
                  ...
                  <div style={{ marginBottom: '8px', display: 'flex' }}>
                    ...
                    <div>
                      <p style={{ margin: '4px 0' }}>
                        <span className={`font-bold me-2 ${!captainData?.sDescription && 'd-block'}`}>{captainData?.oPlayerFan?.oPlayer?.sFirstName}</span>{' '}
                        <span style={{ color: '#50555D' }}>
                          {captainData?.oPlayerFan?.oTeam?.sAbbr && captainData?.oPlayerFan?.oTeam?.sAbbr + ' | '} {captainData?.oPlayerFan?.oPlayer?.sPlayingRole.toUpperCase()}
                        </span>
                      </p>
              ...
              fantasyArticleData?.aTopicPicksFan?.map((topPickData, index) => (
                <div key={index}>
                  <div style={{ marginBottom: '8px', display: 'flex' }}>
                    ...
                    <div>
                      <p style={{ margin: '4px 0' }}>
                        <span className={`font-bold me-2 ${!topPickData?.sDescription && 'd-block'}`}>{topPickData?.oPlayerFan?.oPlayer?.sFirstName}</span>{' '}
                        <span style={{ color: '#50555D' }}>
              ...
              fantasyArticleData?.aBudgetPicksFan?.map((budgetData, index) => (
                <div key={index}>
                  <div style={{ marginBottom: '8px', display: 'flex' }}>
                    ...
                    <div>
                      <p style={{ margin: '4px 0' }}>
                        <span className={`font-bold me-2 ${!budgetData?.sDescription && 'd-block'}`}>{budgetData?.oPlayerFan?.oPlayer?.sFirstName}</span>{' '}
                        <span style={{ color: '#50555D' }}>
                          {budgetData?.oPlayerFan?.oTeam?.sAbbr && budgetData?.oPlayerFan?.oTeam?.sAbbr + ' | '} {budgetData?.oPlayerFan?.oPlayer?.sPlayingRole.toUpperCase()}
                        </span>
                      </p>
                ...
                fantasyArticleData?.aAvoidPlayerFan.map((player, index) => (
                  <div key={index}>
                    <div className="item d-flex align-items-center mb-2">
                      <div style={{ marginRight: '16px', textAlign: 'center', flexShrink: '0' }}>
                        <img src={`${S3_PREFIX}static/player-placeholder-min.jpeg`} alt="user" placeholder="blur" layout="responsive" width="64" height="64" />
                        <div style={pillStyle}>
