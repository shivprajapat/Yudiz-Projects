            ...
            <div className={`common-box ${styles.login}`}>
              ...
              <div md={6} className={styles.innerCol}>
                <Form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
                  ...
                  <Form.Group className={`${formStyles.formGroup} ${formStyles.formCheck}`} controlId="acceptCheckbox">
                    <Form.Check.Input type="checkbox" onChange={checkChangeHandle} />
                    <Form.Check.Label>
                      {t('common:Iaccept')}{' '}
                      <Link href={allRoutes.termsAndConditions} prefetch={false}>
                        <a className="theme-text">{t('common:TermsandConditions')}</a>
                      </Link>
                    </Form.Check.Label>
                  </Form.Group>
                  <Button
                  ...
                  >
                    {t('common:SignUp')}
                    {(sendOtpLoading || userExistsLoading) && <Spinner className="ms-2 align-middle" animation="border" size="sm" />}
                  </Button>
