...
function CricSpecial() {
  ...
  return (
    <>
      {data?.getCricSpecial?.aResults.length !== 0 && <div className={`${styles.cricSpecial} cric-special widget`}>
        ...
        {!loading && <Slider autoplay single dots className="process-arrow">
