...
const SocialShareList = ({ seoData }) => {
  ...
  return (
    <div className={`${styles.socialShareList} d-flex`}>
      ...
      <Dropdown.Item onClick={(e) => handleCopy(e)} className={`${styles.item} ${styles.copy} d-flex align-items-center justify-content-center rounded-circle`}>
