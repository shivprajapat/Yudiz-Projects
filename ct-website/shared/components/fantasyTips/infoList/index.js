    ...
    <section className="common-section pb-0">
      <Row className={`${styles.list}`}>
        {overViewData?.sWeatherReport && (
          <Col sm={6}>
            <section className={`${styles.item} d-flex d-sm-block align-items-center justify-content-between mb-2 mb-md-4`}>
              <p
                className={`${fantasystyles?.itemTitle} ${styles.itemTitle} text-primary font-bold text-uppercase d-flex align-items-center`}
              >
        ...
        {overViewData?.sPitchCondition && (
          <Col sm={6}>
            <section id="pitch" className={`${styles.item} d-flex d-sm-block align-items-center justify-content-between mb-2 mb-md-4`}>
              <p
                className={`${fantasystyles?.itemTitle} ${styles.itemTitle} text-primary font-bold text-uppercase d-flex align-items-center`}
              >
                <span className={`${styles.icon} me-2`}>
