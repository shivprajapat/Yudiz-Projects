const prod = {
  ...
  FANTASY_NODE_URL: process.env.FANTASY_NODE_URL || 'https://node.fantasywl.in',
  FRONTEND_HOST_URL: process.env.FRONTEND_HOST_URL || 'https://app.fantasywl.in',
  ...
  REDIS_2_HOST: process.env.REDIS_2_HOST || 'localhost',
  REDIS_2_PORT: process.env.REDIS_2_PORT || 6379,
  ...
  CASHFREE_STABLE_URL: process.env.CASHFREE_STABLE_URL || 'https://api.cashfree.com/pg',
  ...
  database: process.env.DB_SQL_NAME || 'fantasy_development',
...
-----END PUBLIC KEY-----`,
  ...
  GAME_DB_POOLSIZE: process.env.GAME_DB_POOLSIZE || 1350,
  MATCH_DB_POOLSIZE: process.env.MATCH_DB_POOLSIZE || 40,
  FANTASY_TEAM_DB_POOLSIZE: process.env.FANTASY_TEAM_DB_POOLSIZE || 40,
  LEAGUES_DB_POOLSIZE: process.env.LEAGUES_DB_POOLSIZE || 90,
  ADMINS_DB_POOLSIZE: process.env.ADMINS_DB_POOLSIZE || 23,
  SERIES_LB_DB_POOLSIZE: process.env.SERIES_LB_DB_POOLSIZE || 40,
  USERS_DB_POOLSIZE: process.env.USERS_DB_POOLSIZE || 1050,
  STATISTICS_DB_POOLSIZE: process.env.STATISTICS_DB_POOLSIZE || 1400,
  BANNERS_DB_POOLSIZE: process.env.BANNERS_DB_POOLSIZE || 1800,
  COMPLAINS_DB_POOLSIZE: process.env.COMPLAINS_DB_POOLSIZE || 40,
  FANTASYTIPS_DB_POOLSIZE: process.env.FANTASYTIPS_DB_POOLSIZE || 400,
  PROMOCODES_DB_POOLSIZE: process.env.PROMOCODES_DB_POOLSIZE || 40,
  GEO_DB_POOLSIZE: process.env.GEO_DB_POOLSIZE || 20,
  NOTIFICATION_DB_POOLSIZE: process.env.NOTIFICATION_DB_POOLSIZE || 60,
  REPORT_DB_POOLSIZE: process.env.REPORT_DB_POOLSIZE || 40,
