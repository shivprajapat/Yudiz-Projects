const staging = {
  ...
  FANTASY_NODE_URL: process.env.FANTASY_NODE_URL || 'https://nodestag.fantasywl.in',
  ...
  MATCH_DB_URL: process.env.MATCH_DB_URL || 'mongodb+srv://yudiz_ravi:FiLJqav2zq4tQOrz@cluster0.dnxst.mongodb.net/fantasy_stag_match?retryWrites=true&w=majority',
  FANTASY_TEAM_DB_URL: process.env.FANTASY_TEAM_DB_URL || 'mongodb+srv://yudiz_ravi:FiLJqav2zq4tQOrz@cluster0.dnxst.mongodb.net/fantasy_stag_teams?retryWrites=true&w=majority',
  REPORT_DB_URL: process.env.REPORT_DB_URL || 'mongodb+srv://yudiz_ravi:FiLJqav2zq4tQOrz@cluster0.dnxst.mongodb.net/fantasy_stag_report?retryWrites=true&w=majority',
  SERIES_LB_DB_URL: process.env.SERIES_LB_DB_URL || 'mongodb+srv://yudiz_ravi:FiLJqav2zq4tQOrz@cluster0.dnxst.mongodb.net/fantasy_stag_seriesLB?retryWrites=true&w=majority',
  ...
  USER_MESSAGE_TITLE: process.env.USER_MESSAGE_TITLE || 'New Message Arrived',
