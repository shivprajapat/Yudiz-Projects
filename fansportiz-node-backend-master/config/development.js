const dev = {
  ...
  FANTASY_NODE_URL: process.env.FANTASY_NODE_URL || 'https://node-dev.fantasywl.in',
  FRONTEND_HOST_URL: process.env.FRONTEND_HOST_URL || 'https://app-dev.fantasywl.in',
  SUPERUSER_ID: process.env.SUPERUSER_ID || '625429308cfe9babd81f18a7',

  DISABLE_ADMIN_ROUTES: process.env.DISABLE_ADMIN_ROUTES === 'true',
  THRESHOLD_RATE_LIMIT: process.env.THRESHHOLD_RATE_LIMIT || 0,
...
-----END PUBLIC KEY-----`,
  ...
  GAME_DB_POOLSIZE: process.env.GAME_DB_POOLSIZE || 50,
  MATCH_DB_POOLSIZE: process.env.MATCH_DB_POOLSIZE || 50,
