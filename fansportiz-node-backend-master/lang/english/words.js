module.exports = {
  ...
  LastMatchPlayer: 'Last Match Player',
  matchPlayerRefresh: 'Match Player Refresh',
  ...
  caadharcardStatus: 'Aadhar Card status',
  ...
  bot: 'Bot',
  copyBotNumber: 'Copy bot number',
  bBotCreate: 'Bot creation',
  ...
  cLive: 'Live',
  cInreview: 'In-Review',
  dream_team_creation_error: 'Dream Team Creation',
  dream_team: 'Dream Team',
  user_type: 'User Type',
  extrawin_list: 'Extra Win List',
  leagueAnalytics: 'League Analytics',
  combination_bot: 'Combination bots',
  baseTeam: 'Base Team',
  cMatchTeams: 'Match Teams',
