...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    queryInterface.createTable('userleagues', {
      ...
      nBonusWin: { type: Sequelize.FLOAT(9, 2), defaultValue: 0 },
      nFinalAmount: { type: Sequelize.FLOAT(9, 2), defaultValue: 0 },
      nPrice: { type: Sequelize.FLOAT(9, 2), defaultValue: 0 },
      nPricePaid: { type: Sequelize.FLOAT(9, 2), defaultValue: 0 },
      nTdsFee: { type: Sequelize.FLOAT(9, 2), defaultValue: 0 },
      nTdsPercentage: { type: Sequelize.FLOAT(9, 2), defaultValue: 0 },
