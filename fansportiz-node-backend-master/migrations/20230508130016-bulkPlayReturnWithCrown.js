...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    CREATE DEFINER='yudiz_ravi'@'%' PROCEDURE bulkPlayReturnWithCrown(IN iId varchar(24))
BEGIN
...
SET SESSION transaction_isolation = 'READ-COMMITTED';
                START TRANSACTION;
                    ...
                    IF (!count1) THEN  
                        SELECT 
                            'nAmount', 'nBonus', 'nCash', 'nCrown', 'nOldDepositBalance', 'nNewDepositBalance', 'nOldWinningBalance', 'nNewWinningBalance'
                            INTO nAmount3, nBonus3, nCash3, nCrown3, nOldDepositBalance3, nNewDepositBalance3, nOldWinningBalance3, nNewWinningBalance3
                        ...
                        UPDATE 
                            userbalances SET nCurrentWinningBalance=nCurrentWinningBalance + (nOldWinningBalance3 - nNewWinningBalance3),
                            nCurrentDepositBalanc=nCurrentDepositBalance + (nOldDepositBalance3 - nNewDepositBalance3),
                            nCurrentTotalBalance=nCurrentTotalBalance + nCash3,
                            nTotalCrownUsed=nTotalCrownUsed + nCrown3,
                        ...
                        INSERT INTO passbooks 
                            (id,iUserId,nAmount,nBonus,nCash, nCrown,
                        ...
                        VALUES (DEFAULT,iUserId1, nAmount3,nBonus3, nCash3, nCrown3,
...
END
  ...
  async down (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
    DROP PROCEDURE IF EXISTS bulkPlayReturnWithCrow;
  `)
  }
}
