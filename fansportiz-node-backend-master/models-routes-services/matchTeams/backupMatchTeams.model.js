...
const BackupMatchTeams = new Schema({
...
BackupMatchTeams.index({ iMatchId: 1, sHash: 1 })

BackupMatchTeams.virtual('aPlayers.oMatchPlayer', {
...
BackupMatchTeams.virtual('aPlayers.oTeams', {
  ref: TeamModel,
...
module.exports = FantasyTeamConnect.model('backupmatchteams', BackupMatchTeams)
