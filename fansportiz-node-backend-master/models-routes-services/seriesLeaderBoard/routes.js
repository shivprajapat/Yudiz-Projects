...
const { validateAdmin, validate, isUserAuthenticated } = require('../../middlewares/middleware')
...
router.get('/admin/series-leaderboard/v1', validators.adminListSeriesLeaderBoard, validateAdmin('SERIES_LEADERBOARD', 'R'), SeriesLeaderBoardServices.adminListId)
...
router.get('/user/series-leaderboard-category/:id/v1', cacheRoute(120), SeriesLeaderBoardServices.getCategory)
router.get('/user/series-leaderboard-category-list/:id/v1', cacheRoute(120), SeriesLeaderBoardServices.userListCategory)
...
router.get('/user/series-leaderboard-get-allrank/:id/v1', validators.getAllRankV2, validate, cacheRoute(120), SeriesLeaderBoardServices.getAllRankV2)
router.get('/user/series-leaderboard-get-allrank/:id/v2', validators.getAllRankV2, validate, cacheRoute(120), SeriesLeaderBoardServices.getAllRankV2)
