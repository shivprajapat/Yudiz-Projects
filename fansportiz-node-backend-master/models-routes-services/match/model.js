...
const Match = new Schema({
  ...
  bDreamTeam: { type: Boolean, default: false },
  ...
  eStreamType: { type: String, enum: data.eStreamType, default: 'YOUTUBE' },
  ...
  nLeagueTotalPayout: { type: Number, default: 0 },
  iGrandLeagueId: { type: Schema.Types.ObjectId, default: null },
  sLastUpdatedTill: { type: String },
  bIsNameUpdated: { type: Boolean, default: false },
  bMatchTeamBackup: { type: Boolean, default: false },
  bUserTeamBackUp: { type: Boolean, default: false },
  sPitchDetails: { type: String },
  nAvgVenueScore: { type: Number } // Average score of the venue
