...
router.get('/user/match/list/v1', validators.upcomingMatchList, cacheRoute(10), matchServices.upcomingMatchList)
router.get('/user/match/stream-button/v1', cacheRoute(20), matchServices.matchStreamButton)
router.get('/user/match/stream-list/:type/v1', validators.matchStreamList, cacheRoute(30), matchServices.matchStreamList)
router.get('/user/match/:id/v1', validators.userGetMatch, validate, cacheRoute(5), matchServices.getMatchInfo)
