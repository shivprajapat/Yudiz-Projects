...
const s3 = new AWS.S3({ accessKeyId: process.env.AWS_ACCESSKEYID, secretAccessKey: process.env.AWS_SECRETKEY, signatureVersion: 'v4', region: process.env.AWS_REGION })
