export default function OneN() {
  return (
    <svg width="56" height="40" viewBox="0 0 56 40" fill="none" >
      <g clipPath="url(#clip0_31_222)">
        <rect x="9" y="1" width="38" height="38" rx="19" fill="#C7C7C7" />
        <circle cx="32.5" cy="19.5" r="19.5" fill="#E6E6E6" />
        <g clipPath="url(#clip1_31_222)">
          <rect x="35" y="2" width="14" height="14" rx="7" fill="#BFBFBF" />
          <ellipse cx="44" cy="8.5" rx="7" ry="7.5" fill="#CECECE" />
        </g>
        <g clipPath="url(#clip2_31_222)">
          <rect x="20" y="18" width="9" height="9" rx="4.5" fill="#BFBFBF" />
          <circle cx="26.5" cy="22.5" r="4.5" fill="#CECECE" />
        </g>
        <g clipPath="url(#clip3_31_222)">
          <rect x="33.0117" y="32" width="9" height="9" rx="4.5" transform="rotate(0.072308 33.0117 32)" fill="#BFBFBF" />
          <circle cx="39.506" cy="36.5081" r="4.5" transform="rotate(0.072308 39.506 36.5081)" fill="#CECECE" />
        </g>
        <g clipPath="url(#clip4_31_222)">
      ...
      <defs>
        ...
        <clipPath id="clip3_31_222">
          <rect x="33.0117" y="32" width="9" height="9" rx="4.5" transform="rotate(0.072308 33.0117 32)" fill="white" />
        </clipPath>
