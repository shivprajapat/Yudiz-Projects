    ...
    <div className='d-flex flex-column align-items-center'>
      ...
      <div className={`${styles.matchInfo} d-flex justify-content-center align-items-center`}>
        <div className={styles.teamScore}>
          ...
          <p className="mb-0">{handleScore(match?.oTeamScoreA?.sScoresFull) || <b><Trans i18nKey="common:YetToBat" /></b>}</p>
        </div>
        ...
        <div className={styles.teamScore}>
          ...
          <p className="mb-0">{handleScore(match?.oTeamScoreB?.sScoresFull) || <b><Trans i18nKey="common:YetToBat" /></b>}</p>
        </div>
      </div>
    </div>
  )
