...
const SeriesVideos = ({ data, category, isClientOnly }) => {
  ...
  useEffect(() => {
    if (isClientOnly) {
      if (category?.eType === 's' || category?.eType === 'pct') {
    ...
    <>
      {videosData?.length > 0 && (
        <div className={styles.seriesVideo}>
          ...
          <Row>
            ...
            <Col lg={4}>
              <Row>
                {videosData[1] &&
                  <Col lg={12} sm={6}>
                    <ArticleGrid data={videosData[1]} isVideo={true} isMobileSmall />
                  </Col>
                }
                {videosData[2] &&
                  <Col lg={12} sm={6}>
                    <ArticleGrid data={videosData[2]} isVideo={true} isMobileSmall />
                  </Col>
                }
              </Row>
            </Col>
          ...
          <Row className={styles.seriesVideoList}>
              ...
              if (i > 2) {
                return (
                  <React.Fragment key={video?._id}>
                    ...
                    <Col lg={4} sm={6} id={video?._id}>
                      <ArticleGrid data={video} isVideo={true} isMobileSmall />
                    </Col>
                  </React.Fragment>
                )
              } else return null
