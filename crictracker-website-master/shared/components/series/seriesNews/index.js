...
const SeriesNews = ({ data, category, hideBadge, isClientOnly }) => {
  ...
  useEffect(() => {
    if (isClientOnly) {
      ...
      } else if (category?.eType === 's' || category?.eType === 'fac' || category?.eType === 'pct') { // simple category
                ...
                return (
                  <React.Fragment key={news._id}>
                    <Col xs={12} id={news?._id}>
                      <ArticleSmall isLarge={true} data={news} hideBadge={hideBadge} isMobileBig />
                    </Col>
                ...
                return (
                  <React.Fragment key={news._id}>
                    <Col lg={4} sm={6} id={news?._id}>
                      <ArticleGrid data={news} isMobileSmall />
                    </Col>
