...
export const ARTICLE_REST_URL = process.env.REACT_APP_ARTICLE_REST_URL || 'https://article.crictracker.com'
...
export const GLANCE_MOBILE = ['r', 'x', 's']
export const PLAY_STORE_URL = 'https://play.google.com/store/apps/details?id=com.app.crictracker'
export const APP_STORE_URL = 'https://apps.apple.com/in/app/crictracker/id6443913175'
export const GLANCE_MOBILE_UNIT = {
  x: 'xiaomi_lp',
  r: 'Realme',
  s: 'samsung'
}
export const IS_GLANCE_MLIB = true
export const GLANCE_MOBILE_UNIT_MLIB = {
  v: 'Vivo',
  o: 'oppo1',
  o2: 'Oppo',
  s: 'samsungdlss',
  ...
  mgo: 'motorolago',
  maosp: 'motorolaaosp',
  maosp1: 'motorolaaosp1',
  trans: 'transsion',
  jio: 'jio',
  softbxiaomi: 'softbxiaomi',
  softbmoto: 'softbmoto'
}
...
export const DESIGNATION = [
  { label: 'Staff Writer', value: 'jsw' },
  { label: 'Sr. Staff Writer', value: 'ssw' },
  { label: 'Correspondent', value: 'jc' },
...
export const ELEVEN_WICKETS = 'https://bit.ly/3VsKYDL'
...
export const CT_WHATS_APP_LINK = 'https://wa.link/ct1'
