...
const dev = {
  ...
  DB_URL: process.env.DB_URL || 'mongodb://localhost:27017/crictracker-widget-dev',
  CONNECTION: parseInt(process.env.CONNECTION) || 25,
  ...
  SENTRY_DSN: process.env.SENTRY_DSN || 'https://687506b31d904b33ba3482cff24e9b50@o992135.ingest.sentry.io/6725474',
  ...
  globalWidgetGrpcUrl: process.env.GLOBAL_WIDGET_GRPC_URL || '0.0.0.0:3006',
...
const prod = {
  PORT: process.env.PORT || 4006,
  DB_URL: process.env.DB_URL || 'mongodb://localhost:27017/crictracker-widget-stag',
  CONNECTION: parseInt(process.env.CONNECTION) || 25,
  DOMAIN_NAME: process.env.DOMAIN_NAME || 'crictracker.com',
  AUTH_SUBGRAPH_URL: process.env.AUTH_SUBGRAPH_URL || 'http://localhost:4001/',
  SENTRY_DSN: process.env.SENTRY_DSN || 'https://e1b5454e4b354a199c91c125647f286f@o992135.ingest.sentry.io/6725514',
  ENTITY_SPORT_BASE_URL: process.env.ENTITY_SPORT_BASE_URL || 'https://rest.entitysport.com/v2',
  ENTITY_SPORT_TOKEN: process.env.ENTITY_SPORT_TOKEN || 'd63f2f01c116136d404f0c2d3a69a53c',
...
const test = {
  PORT: process.env.PORT || 4006,
  DB_URL: process.env.TEST_DB_URL || 'mongodb://localhost:27017/crictracker-widget-test',
  CONNECTION: parseInt(process.env.CONNECTION) || 25,
  DOMAIN_NAME: process.env.DOMAIN_NAME || 'crictracker.com',
  AUTH_SUBGRAPH_URL: process.env.AUTH_SUBGRAPH_URL || 'http://localhost:4001/',
  SENTRY_DSN: process.env.SENTRY_DSN || 'https://687506b31d904b33ba3482cff24e9b50@o992135.ingest.sentry.io/6725474',
  ...
  CREATE_CURRENT_SERIES_EVENT: process.env.CREATE_CURRENT_SERIES_EVENT || 'create-current-series-event',
  CREATE_CURRENT_SERIES_GROUP: process.env.CREATE_CURRENT_SERIES_GROUP || 'create-current-series-group',
  MATCH_MANAGEMENT_SUBGRAPH_URL: process.env.MATCH_MANAGEMENT_SUBGRAPH_URL || 'https://matchmanage-dev.crictracker.ml/graphql',
