      ...
      <Form hidden={hidden} className="step-two" autoComplete="off" id="stepTwoForm">
        ...
        <Form.Group className="form-group">
          ...
          <Form.Control
            ...
            {...register('donationPercentage', {
              required: validationErrors.required,
              validate: (value) => value >= 0.5 || validationErrors.donationPercentage
            })}
        ...
        <Form.Group className="form-group">
          ...
          <div className="d-flex min-bid">
            ...
            <div className="min-bid-inner">
              ...
              {/* TODO: */}
              {/* {errors.networkSellingPrice && (
                <Form.Control.Feedback type="invalid" className="invalidFeedback">
                  {errors.networkSellingPrice.message}
                </Form.Control.Feedback>
              )} */}
            </div>
          </div>
        ...
        <Form.Group className="form-group">
          <Form.Label>
            ...
            <Form.Text className="text-muted mx-1">
              (<FormattedMessage id="connectYourAccountToAutoFill" />)
            </Form.Text>
          </Form.Label>
          <Form.Control
            type="text"
            ...
            placeholder={labels.walletAddress}
          />
